...
function generate_table_WBS_task(data) {
   ...
   Object.keys(data).forEach(function(k) {
      if (k == "") { //<input class="check_wbs_row" type="checkbox" name="check_wbs_row[]" value="' + k + '">
         html += '<tr style="background-color:lightblue;" class="header" data_wbs="null_value"><td><input class="WBS_tr" type="checkbox" name="WBS_tr[]" value="null_wbs"></td><td><span class="btn btn-primary btn-sm">-</span></td><td></td><td></td><td>' + k + '('+ data[k].length+')</td></tr>';
         let i = 1;
         ...
         html += '<tr style="background-color:lightblue;" class="header" data_wbs="' + k + '"><td><input class="WBS_tr" type="checkbox" name="WBS_tr[]" value="' + k + '"></td><td><span class="btn btn-primary btn-sm">-</span></td><td></td><td></td><td>' + k + '('+ data[k].length+')</td></tr>';
         let i = 1;
         Object.keys(data[k]).forEach(function(sub_loop) {
            html += '<tr>';
