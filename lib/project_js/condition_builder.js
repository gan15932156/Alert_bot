   ...
   $("#alert_data_type").change(function(){
      if($(this).val() != "null"){
         if($("#alert_data_type option:selected").val() == "1"){
            ...
            let html = '';
            html += '<div class="row"><label>กรอกข้อความ</label> &nbsp;&nbsp;<input type="text" class="form-control form-control-sm col-md-10" name="alert_data_type_value" id="alert_data_type_value"></div>';        
