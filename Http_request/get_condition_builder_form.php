...
function generate_main_sql_condition($conditions,$fields_json){// return main sql condition
   $sql = '';
   if(empty($conditions['oplist'])){// ตรวจสอบเงื่อนไขแรก จะไม่มี AND และ OR
      $sql.= ' ';
   }
   else{
...
function generate_sub_sql_condition($conditions,$fields_json){// return sub sql condition
